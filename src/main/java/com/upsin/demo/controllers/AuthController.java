...
public class AuthController {
    ...
    @Operation(summary = "Registrar un nuevo Paciente", description = "Crea un usuario con el rol 'paciente', encripta su contraseña, le asigna un psicólogo de planta y le genera un expediente clínico en blanco de forma automática.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Paciente registrado exitosamente"),
            @ApiResponse(responseCode = "400", description = "Datos inválidos (ej. correo duplicado o mal formado)")
    })
